...
1. Criar o Banco de Dados
   No terminal do seu Codespace, crie o arquivo do banco de dados utilizando o seu nome. Substitua seu_nome pelo seu nome real:
...
Dentro do prompt do SQLite (sqlite>), crie uma tabela chamada contatos com a seguinte estrutura:
id: Número inteiro e Chave Primária (com incremento automático).
...
Insira pelo menos 3 registros diferentes na tabela para popular o banco.
Exemplo de comando:

sql
INSERT INTO contatos (nome, telefone, email) VALUES ('Ana Silva', '11 98888-7777', 'ana@email.com');
Use o código com cuidado.
...
Digite SELECT \* FROM contatos; e verifique se os 3 nomes aparecem.
Saia do SQLite digitando .exit ou .quit.

#📤 Entrega (Git)
Para que eu possa corrigir, você precisa enviar o arquivo .db para o GitHub. Use os comandos abaixo no terminal:

bash
git add seu_nome.db
git commit -m "Tarefa SQLite: Banco e tabela de contatos criados"
